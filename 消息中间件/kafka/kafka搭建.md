...
如果jdk版本小于1.8 建议先安装jdk1.8，修改JAVA_HOME 环境变量。
...
执行 tar -zxvf kafka_2.13-2.5.0.tgz 解压 kafka。
...
# cluster mode
server.1=10.20.0.22:2888:3888
server.2=10.20.0.19:2888:3888
server.3=10.20.0.20:2888:3888
```
...
broker.id=1
# listeners=PLAINTEXT://10.20.0.22:9092
